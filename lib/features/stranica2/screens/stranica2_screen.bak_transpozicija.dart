...
import '../widgets/edit_dugme_widget.dart';import '../controllers/transpozicija_controller.dart';
...
class _Stranica2ScreenState extends State<Stranica2Screen> {
  ...
  Future<void> _ucitajTekst() async {
    ...
    if (await file.exists()) {
      ...
      setState(() {
        final transponirani = TranspozicijaController.transponirajTekst(text);`r`n      ucitaniTekst = transponirani;`r`n      textController.text = transponirani;
 ...
 -replace 'final transponirani = TranspozicijaController.transponirajTekst(text);
ucitaniTekst = transponirani;
textController.text = transponirani;', 'final transponirani = TranspozicijaController.transponirajTekst(text);
      ucitaniTekst = transponirani;
      textController.text = transponirani;'
